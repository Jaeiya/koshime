...
// SetAnimeStatus sets the status of a specific anime within
// the users library. On success, the active status is returned.
func SetAnimeStatus(libID, token string, status LibAnimeStatus) (LibAnimeStatus, error) {
...
// DeleteAnime deletes a specific anime from a users
